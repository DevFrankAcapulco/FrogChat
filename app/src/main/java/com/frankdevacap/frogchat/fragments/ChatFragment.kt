...
import com.frankdevacap.frogchat.adapters.ChatAdapter
import com.frankdevacap.frogchat.models.Message
import com.frankdevacap.frogchat.toast
...
class ChatFragment : Fragment() {
    ...
    private fun setUpChatDB(){
        chatDBRef = store.collection("GrupoChat")
    ...
    private fun setUpRecyclerView(){
        ...
        _view.recyclerView.setHasFixedSize(false)
    ...
    private fun subscribeToChatMessages(){
        chatSubscription = chatDBRef
            ...
            .addSnapshotListener(object: EventListener, com.google.firebase.firestore.EventListener<QuerySnapshot>{
                override fun onEvent(snapshot: QuerySnapshot?, exeption: FirebaseFirestoreException?) {
                    exeption?.let {
                        activity!!.toast("Exception! Fallo en la matrix")
                        return
                    }
